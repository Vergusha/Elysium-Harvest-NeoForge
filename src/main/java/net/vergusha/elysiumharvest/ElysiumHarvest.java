...
public class ElysiumHarvest {
    ...
    public static final ArmorMaterial FLORITE_ARMOR_MATERIAL = new ArmorMaterial(
            ...
            ItemTags.IRON_TOOL_MATERIALS, // Repair ingredient tag
            ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.fromNamespaceAndPath(MODID, "florite")));
    ...
    public static final DeferredBlock<Block> DEEPSLATE_FLORITE_ORE = BLOCKS.registerSimpleBlock("deepslate_florite_ore",
    ...
    // Florite Tools - based on documentation
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS
            .register("example_tab", () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.elysiumharvest")) // The language key for the title of your
                                                                               // CreativeModeTab
